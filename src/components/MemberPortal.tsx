...
export default function MemberPortal({
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-white p-5 rounded-2xl border border-slate-100 shadow-xs space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-display font-bold text-slate-800">Gym Attendance Insights</h3>
                  <p className="text-[10px] text-slate-400">Monthly check-in records across all portals</p>
                </div>
                <span className="text-xs font-mono font-bold text-sky-500 px-2 py-0.5 rounded-md bg-sky-50">
                  +15% vs Last Quarter
                </span>
              </div>
              ...
              <div className="h-56 w-full flex flex-col justify-between pt-4 select-none">
                <div className="flex-1 flex items-end justify-between gap-1.5 px-1 relative h-[180px]">
                  {/* Grid Lines */}
                    ...
                    return (
                      <div key={index} className="flex-1 flex flex-col items-center group relative z-10 h-full justify-end">
                        ...
                        <div className="absolute bottom-full mb-2 hidden group-hover:flex flex-col items-center pointer-events-none z-30 animate-fade-in whitespace-nowrap">
                          <div className="bg-slate-900 text-white px-2.5 py-1.5 rounded-lg text-[10px] font-bold shadow-md border border-slate-800">
                            <p className="font-bold text-slate-300">{item.name}</p>
                            <p className="text-sky-400">+{item.count} check-ins</p>
                          </div>
                        ...
                        {/* Bar */}
                        <div 
                          className="w-full bg-sky-600 hover:bg-sky-500 rounded-t-sm transition-all duration-300 relative cursor-pointer"
                          style={{ height: `${heightPercent}%` }}
                        >
                          {/* Pulsing top highlight for selected/high month */}
                          {item.count > 60 && (
                            <span className="absolute top-0 left-0 right-0 h-0.5 bg-sky-300 rounded-t-sm animate-pulse"></span>
                          )}
                        </div>
                        
                        {/* Label */}
                        <span className="text-[9px] font-semibold text-slate-400 mt-2 font-mono">
                          {item.name}
                        </span>
                      </div>
                    );
            ...
            <div className="lg:col-span-5 bg-white p-5 rounded-2xl border border-slate-100 shadow-xs space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-display font-bold text-slate-800">Popular Classes</h3>
                  <p className="text-[10px] text-slate-400">High-enrollment group exercise programs</p>
                </div>
                <button 
                  onClick={() => setActiveTab('schedule')}
                  className="text-xs text-sky-500 hover:text-sky-600 font-semibold inline-flex items-center gap-1 cursor-pointer"
                >
              ...
              <div className="space-y-3.5">
                ...
                <div className="relative group overflow-hidden rounded-xl bg-gradient-to-br from-indigo-50 to-indigo-100/60 p-4 border border-indigo-100 flex flex-col justify-between h-28">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="text-xs font-bold text-slate-800">Routine Workout</h4>
                      <p className="text-[10px] text-slate-500 mt-0.5">Strength training program with overlapping squats.</p>
                    </div>
                    <span className="text-[9px] bg-indigo-500 text-white px-1.5 py-0.5 rounded-md font-semibold">
                      9:30 AM
                    </span>
                  </div>
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <div className="flex -space-x-2 overflow-hidden">
                      <img className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=50&auto=format&fit=crop" alt="Member" referrerPolicy="no-referrer" />
                      <img className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=50&auto=format&fit=crop" alt="Member" referrerPolicy="no-referrer" />
                      <img className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=50&auto=format&fit=crop" alt="Member" referrerPolicy="no-referrer" />
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[8px] font-bold text-white ring-2 ring-white">+12</div>
                    </div>
                    <button 
                ...
                <div className="relative group overflow-hidden rounded-xl bg-gradient-to-br from-pink-50 to-pink-100/60 p-4 border border-pink-100 flex flex-col justify-between h-28">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="text-xs font-bold text-slate-800">Bodybuilding Elite</h4>
                      <p className="text-[10px] text-slate-500 mt-0.5">Heavy compound lift progressions under Sarah.</p>
                    </div>
                    <span className="text-[9px] bg-pink-500 text-white px-1.5 py-0.5 rounded-md font-semibold">
                      11:00 AM
                    </span>
                  </div>
                  <div className="flex items-center justify-between pt-2">
                    {/* Overlapping Avatars */}
                    <div className="flex -space-x-2 overflow-hidden">
                      <img className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=50&auto=format&fit=crop" alt="Member" referrerPolicy="no-referrer" />
                      <img className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=50&auto=format&fit=crop" alt="Member" referrerPolicy="no-referrer" />
                      <img className="inline-block h-6 w-6 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=50&auto=format&fit=crop" alt="Member" referrerPolicy="no-referrer" />
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-pink-600 text-[8px] font-bold text-white ring-2 ring-white">+8</div>
                    </div>
                    <button 
                      onClick={() => alert("Current members attending: Jakob Dorwort, Sarah Jenkins, John Watson, Chloe Bennett.")}
                      className="text-[10px] font-semibold text-pink-600 hover:text-pink-800 underline cursor-pointer"
                    >
                      See all members
                    </button>
                  </div>
      ...
      {/* VIEW: Coach Messages */}
      {activeTab === 'messages' && (
        <div className="bg-white rounded-xl border border-slate-100 shadow-xs max-w-2xl mx-auto flex flex-col h-[520px] overflow-hidden">
